...
let pathFile1 = await writeExif(media, { packname: options.packname ? options.packname : 'CASA BOT', author: options.author ? options.author : '', categories: options.categories ? options.categories : [] })
